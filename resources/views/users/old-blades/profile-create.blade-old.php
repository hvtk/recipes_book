                                ...
                                <div class="grid md:grid-cols-2 text-sm">
                                    <div class="grid grid-cols-2">
                                        ...
                                        <input class="w-100 mt-2 py-2 px-4 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-50 font-semibold focus:border-blue-500 focus:outline-none"
                                            ...
                                            value="{{ old('profile_users_first_name') }}"
                                        /> 
                                    ...
                                    <div class="grid grid-cols-2">
                                        ...
                                        <label for="profile_users_last_name"
                                                class="px-4 py-2 font-semibold"
                                            >
                                        ...
                                        <input class="w-100 mt-2 py-2 px-4 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-50 font-semibold focus:border-blue-500 focus:outline-none"
                                            ...
                                            value="{{ old('profile_users_last_name') }}"
                                        /> 
                                    ...
                                    <div class="grid grid-cols-2">
                                        ...
                                        <input class="w-100 mt-2 py-2 px-4 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-50 font-semibold focus:border-blue-500 focus:outline-none"
                                            ...
                                            id="" 
                                            placeholder="Gender" 
                                            value="{{ old('profile_users_gender') }}"
                                        /> 
                                    ...
                                    <div class="grid grid-cols-2">
                                        ...
                                        <input class="w-100 mt-2 py-2 px-4 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-50 font-semibold focus:border-blue-500 focus:outline-none"
                                            ...
                                            id="" 
                                            placeholder="Street" 
                                            value="{{ old('profile_users_street') }}"
                                        /> 
                                    ...
                                    <div class="grid grid-cols-2">
                                        ...
                                        <input class="w-100 mt-2 py-2 px-4 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-50 font-semibold focus:border-blue-500 focus:outline-none"
                                            ...
                                            value="{{ old('profile_users_streetnumber') }}"
                                        /> 
                                    ...
                                    <div class="grid grid-cols-2">
                                        ...
                                        <input class="w-100 mt-2 py-2 px-4 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-50 font-semibold focus:border-blue-500 focus:outline-none"
                                            ...
                                            value="{{ old('profile_users_postalcode') }}"
                                        /> 
                                    ...
                                    <div class="grid grid-cols-2">
                                        ...
                                        <input class="w-100 mt-2 py-2 px-4 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 dark:text-gray-50 font-semibold focus:border-blue-500 focus:outline-none"
                                            ...
                                            value="{{ old('profile_users_birthday') }}"
                                        /> 
